...
/*#if !UNITY_5
	...
	public static class MonoBehaviourExtensions
	{
		...
		public static GameObject Find(this Component component, string childName)
		{
			return component.transform.Find(childName).gameObject;
		}

		public static GameObject Find(this Component component, string childName, bool recursive)
		{
